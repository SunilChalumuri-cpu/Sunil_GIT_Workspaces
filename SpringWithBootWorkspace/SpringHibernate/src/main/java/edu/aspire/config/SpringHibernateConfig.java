...
public class SpringHibernateConfig {
	 ...
	 * 
	 * @Bean public DataSource dataSource(@Value("${jdbc.driverClass}") String
	 * driverClass,
	 * 
	 ...
	 * 
	 * @Value("${jdbc.maxPoolSize}") int maxPoolSize) { BasicDataSource bds = new
	 * BasicDataSource(); bds.setDriverClassName(driverClass); bds.setUrl(url);
	 * bds.setUsername(username); bds.setPassword(password);
	 * bds.setInitialSize(initPoolSize); bds.setMaxActive(maxPoolSize); return bds;
	 * }
	 */
